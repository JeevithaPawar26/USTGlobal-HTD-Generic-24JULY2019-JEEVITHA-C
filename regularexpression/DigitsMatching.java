...
public class DigitsMatching {
	...
	public static void main(String[] args) {
		...
		pat=Pattern.compile("[1-9]|1[0-9]|2[0-9]|3[0-9]");// for range of values
		//mat = pat.matcher("29"); 
		mat = pat.matcher("40"); 
		System.out.println(mat.matches());
		/*
		 * []---> for range of values {}---> number of digits/value entered validate
		 * using regEx underscore is taken as character in regEx not as special
		 * character
		 */
	}
